...
$sql = "SELECT * FROM book where book_id <= 6 order by book_id asc;";
					...
					<div class="single-products">
							...
							<div class="product-overlay">
									<div class="overlay-content">
										...
										<p><?php echo $row['book_price']*0.60 .'.00 <i class="fas fa-rupee-sign"></i>'?> </p>
										<p> <?php echo '<i class="fas fa-map-marker-alt"></i>  ' . $row['area'] ?>, <?php echo $row['city'] ?></p>
										<a href="login.php" class="btn btn-default add-to-cart"><i class="fas fa-book"></i>View Book</a>
									</div>
							</div>
					</div>
					<div class="choose">
							<ul class="nav nav-pills nav-justified">
								<li><a href="login.php"><input class="btn btn-primary btn-sm" type="submit" name="add_to_cart" value="Add To Cart" style="margin-left:;margin-top: 20px"></a></li>
								<li><?php echo '<a href="login.php" ><i class="fas fa-plus-square"></i>View Book details</a>';
								?></li>
							</ul>
					</div>
			</div>
...
$sql = "SELECT * FROM book where u_id != '$u_id' AND book_id <= 6;";
