...
$sql = "SELECT msg_id,incoming_msg_id,customer.u_name,outgoing_msg_id,msg From messages,customer WHERE incoming_msg_id = customer.u_id and customer.u_name  LIKE '%$s%' order by msg_id asc";
