...
$sql = "SELECT u_id,u_name,u_email,u_number,u_address FROM customer where u_id LIKE '%$s%' or u_name LIKE'%$s%'";
         ...
         <div class="col-xl-12">
            <div class="card">
               <div class="card-body">
                  ...
                  <form action="users_search.php" method="post" style="float: right;">
                     <input type="search" name="sea_user" style="padding-bottom: 4px; border-radius:5px;" />
                     <button class="btn btn-primary" type="submit" name="search" 
                     style="padding-top: 1px;">Search</button>
                  </form>
               </div>
               <div class="card-body--">
